...
namespace QLNet
{
    ...
    #region MonteCarlo
    public class MakeMGenericHestonInstrument<RNG> where RNG : IRSG, new()
    {
        ...
        public MakeMGenericHestonInstrument<RNG> withSteps(int steps)
        {
            steps_ = steps;
            return this;
        }
        public MakeMGenericHestonInstrument<RNG> withStepsPerYear(int steps)
        {
            stepsPerYear_ = steps;
            return this;
        }
        public MakeMGenericHestonInstrument<RNG> withSamples(int samples)
        {
            Utils.QL_REQUIRE(tolerance_ == null, () => "tolerance already set");
            samples_ = samples;
            return this;
        }
        public MakeMGenericHestonInstrument<RNG> withAbsoluteTolerance(double tolerance)
        {
        ...
        public MakeMGenericHestonInstrument<RNG> withMaxSamples(int samples)
        {
            maxSamples_ = samples;
            return this;
        }
        public MakeMGenericHestonInstrument<RNG> withSeed(ulong seed)
        {
            seed_ = seed;
            return this;
        }
        public MakeMGenericHestonInstrument<RNG> withBrownianBridge(bool brownianBridge = true)
        {
        ...
        {
            return new MCGenericHestonInstrument<RNG>(process_,
                                         antithetic_,
                                         steps_,
                                         stepsPerYear_,
                                         samples_,
    ...
    public class MCGenericHestonInstrument<RNG> : MCGenericHestonInstrument<RNG, HestonGenericInstrument.MCHestonGenericEngineBase>
        where RNG : IRSG, new()
    {
    ...
    public class MCGenericHestonInstrument<RNG, GenericEngine> : McSimulation<MultiVariate, RNG, Statistics>, IPricingEngine
        ...
        where RNG : IRSG, new()
    {
        ...
        protected override PathPricer<IPath> pathPricer()
        {
            ...
            Dictionary<string, List<Date>> datesDico = arguments_.datesDico;
            Func<Dictionary<string, List<double>>, Dictionary<string, List<double>>, Handle<YieldTermStructure>, MultiPath, double> scriptDico = arguments_.scriptDico;
            ...
            return new HestonGenericInstrumentPathPricer(scriptDico, timesDico, indexDico, process.riskFreeRate());
        }



        public class HestonGenericInstrumentPathPricer : PathPricer<IPath>
        {


            protected Dictionary<string, List<double>> timesDico_;
            protected Dictionary<string, List<double>> indexDico_;
            protected Func<Dictionary<string, List<double>>, Dictionary<string, List<double>>, Handle<YieldTermStructure>, MultiPath, double> scriptDico_;

            protected Handle<YieldTermStructure> discountTS_;


            public HestonGenericInstrumentPathPricer(Func<Dictionary<string, List<double>>, Dictionary<string, List<double>>, Handle<YieldTermStructure>, MultiPath, double> scriptDico,
            ...
            {
                return scriptDico_(timesDico_, indexDico_, discountTS_, multiPath as MultiPath);
            }
        ...
        protected HestonGenericInstrument.Arguments arguments_ = new HestonGenericInstrument.Arguments();
        protected HestonGenericInstrument.Results results_ = new HestonGenericInstrument.Results();
