...
namespace QLNet
{
    ...
    public class LocalVolSurfaceTolerance : LocalVolSurface
    {
        Handle<BlackVolTermStructure> blackTS_;
        Handle<YieldTermStructure> riskFreeTS_, dividendTS_;
        Handle<Quote> underlying_;

        public LocalVolSurfaceTolerance(Handle<BlackVolTermStructure> blackTS, Handle<YieldTermStructure> riskFreeTS,
