...
namespace QLyx.DataIO.Markit
{
    ...
    public sealed class Markit_Equity_IV_New_Files
    {
        ...
        private Markit_Equity_IV_New_Files(MarkitEquityUnderlying underlying)
        {
        ...
        private class Nested
        {
            ...
            internal static Markit_Equity_IV_New_Files instance(MarkitEquityUnderlying underlying) { return new Markit_Equity_IV_New_Files(underlying); }
        ...
        /// </summary>
        public static Markit_Equity_IV_New_Files Instance(MarkitEquityUnderlying underlying) { return Nested.instance(underlying); }
        ...
        public String indexName
        {
            ...
            private set
            {
                if (!(_indexName == null))
                {
                    throw new System.ArgumentException("ReadOnlyException", "Markit Equity IV object already linked to an index."); }
                _indexName = value;
            }
