...
{
    class FundamentalDataRequest : GenericDataRequest
    {
        ...
        public FundamentalDataRequest(IDtoken Id_, List<string> Fields_, DateTime StartDate_, DateTime EndDate_,
        ...
        public FundamentalDataRequest(IDtoken Id_, DateTime StartDate_, DateTime EndDate_)
        ...
        public FundamentalDataRequest(IDtoken Id_)
