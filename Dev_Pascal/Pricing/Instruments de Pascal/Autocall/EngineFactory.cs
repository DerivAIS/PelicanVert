...
namespace Pascal.Instruments.Derivatives
{
    ...
    */
        ...
        where S : IGeneralStatistics, new()
    {
        ...
        public MCEuropeanAutocallEngine(GeneralizedBlackScholesProcess process, bool brownianBridge, bool antitheticVariate, int? timeSteps = null, int? timeStepsPerYear = null,
                                int? requiredSamples = null, double? requiredTolerance = null, int? maxSamples = null, ulong? seed = 50)
            : base(process, brownianBridge, antitheticVariate, false, timeSteps, timeStepsPerYear, 
        ...
        // MakeMCEuropeanEngine --> MakeMCEuropeanAutocallEngine
    {
        ...
        private bool antithetic_ = true;
        private int? steps_ = null;
        private int? stepsPerYear_ = null;
        private int? samples_ = null;
        private int? maxSamples_ = null;
        private double? tolerance_ = null;
        private bool brownianBridge_ = false;
        private ulong seed_ = 42;
        ...
        {
            if ((tolerance_ != 0) && (tolerance_ != null))
        ...
        {
            if (steps_ == null && stepsPerYear_ == null)
            ...
            return new MCEuropeanAutocallEngine<RNG, S>(process_, brownianBridge_, antithetic_, steps_, stepsPerYear_,
