...
namespace Pascal.Instruments.Derivatives
{
    ...
    {
        protected MCAutocallEngine(StochasticProcess process, bool brownianBridge, bool antitheticVariate, bool controlVariate, int? timeSteps = null,
            int? timeStepsPerYear = null,  int? requiredSamples = null, double? requiredTolerance = null, int? maxSamples = null, ulong? seed = 50)
        ...
        //                          int maxSamples, ulong seed)
            : base(process, brownianBridge, antitheticVariate, controlVariate, timeSteps, timeStepsPerYear,   requiredSamples,
            ...
            where RNG : IRSG, new() where S : IGeneralStatistics, new()
    {
        ...
        protected int? maxSamples_ = 1000000;
        ...
        protected MCAutocallEngine(StochasticProcess process, bool brownianBridge, bool antitheticVariate, bool controlVariate, int? timeSteps = null, 
            int? timeStepsPerYear = null, int? requiredSamples = null, double? requiredTolerance = null,
                                  int? maxSamples = null, ulong? seed = 50) : base(antitheticVariate, controlVariate)
        {
            process_ = process;
            ...
            if (!(timeSteps != null || timeStepsPerYear != null))
                throw new ApplicationException("Under specification: no time steps provided");


            if (!(timeSteps == null || timeStepsPerYear == null))
                throw new ApplicationException("Over specification : both time steps and time steps per year were provided");
        ...
        */
        ...
        protected override TimeGrid timeGrid()
        {
            ...
            if (timeSteps_ != 0)
            {
                ...
                return new TimeGrid(mandatoryTimes, mandatoryTimes.Count, (int)timeSteps_);
            }
            ...
            {
                //throw new ApplicationException("time steps not specified");
                Console.WriteLine("Forcing time grid around mandatoryTimes given by the exercise structure.");
        ...
        protected override IPathGenerator<IRNG> pathGenerator()
        {
            ...
            IRNG generator = (IRNG)new RNG().make_sequence_generator(dimensions * (grid.size() - 1), (ulong)seed_);
